...
const FAQ = () => {
    ...
    const faqs = [
        ...
        {
            q: "Do students need to download a separate app?",
            a: <>Yes, students download the <a href={PREPONE_PLAY_STORE_URL} target="_blank" rel="noreferrer" className="text-[#01696f] font-bold hover:underline">free PrepOne app</a> where they can view their results, detailed analytics, and revision notes generated by CoachOne.</>
        },
